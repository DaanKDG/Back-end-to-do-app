...
<div class="show-section">        
      <div class="card mr-3 mb-4 float-left task-style {{ ($dateToday->gt($task->end_date)) ? 'border-red' : '' }}">
            <div class="top-right-icons">
                  ...
                  @if($task->completed == 0)
                      <a href="{{ route("tasks.edit", ["id" => $task->id]) }}" data-toggle="tooltip" title="Bewerk" class="float-right"><i class="far fa-edit icon-size mr-1 "></i></a>
                  ...
                  <div class="card-body">
                        ...
                        <a href="#" type="" class="" data-toggle="popover"  data-trigger="hover" title="comments" data-html="true"
                               data-content=" @php foreach($task->comments as $comment)
                                              ...
                                              @endphp">
                        <i class="far fa-clipboard icon-size mr-1"></i></a>
                        @if($task->completed == 0) 
